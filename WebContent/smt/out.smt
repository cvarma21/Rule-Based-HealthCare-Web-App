...
(define-fun violation_output0 () Bool (and atleast_two_rules_fire  (not (= output0_rule1  output0_rule3  output0_rule4  output0_rule5  output0_rule9  output0_rule10  )))) 
 
(define-fun violation_output1 () Bool (and atleast_two_rules_fire  (not (= output1_rule2  output1_rule6  output1_rule7  output1_rule8  )))) 
