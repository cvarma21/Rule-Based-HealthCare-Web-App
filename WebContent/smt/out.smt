...
(define-fun output0_rule1 () Int (ite rule1_applies 200 outpp))

(define-fun output0_rule2 () Int (ite rule2_applies 200 outpp))

(define-fun output0_rule3 () Int (ite rule3_applies 200 outpp))


;Define a helper function
(define-fun atleast_two_rules_fire () Bool ((_ at-least 2) rule1_applies rule2_applies rule3_applies ))

;Define the violation for the output variables
(define-fun violation_output0 () Bool (and atleast_two_rules_fire  (not (= output0_rule1  output0_rule2  output0_rule3  )))) 
