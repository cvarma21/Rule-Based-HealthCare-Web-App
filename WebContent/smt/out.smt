...
(define-fun rule2_applies () Bool (and (range abc 10 20)(range def 10 20)))
...
(define-fun violation_output0 () Bool (and atleast_two_rules_fire  (not (= output0_rule1  output0_rule2  )))) 
